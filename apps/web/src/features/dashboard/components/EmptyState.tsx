      ...
      <div className="w-[500px] h-[350px] rounded-lg flex items-center justify-center tracking-[-0.15px] bg-white">
        <div className="flex flex-col items-center gap-y-3 mb-10">
          ...
          <div className="flex flex-col items-center">
            <h1 className="text-lg font-medium">No GitHub Integration Found</h1>
            <p className="text-sm max-w-sm text-center my-2 text-subHeading">
              Connect your GitHub account to enable repositories, automated
              sync, and project insights.
            </p>
          </div>
